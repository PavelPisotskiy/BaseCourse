...
namespace BaseCourse.DataSource.Repositories
{
    public class ProductRepository : IProductRepository
    {
        ...
        public ProductRepository(IRepository<ProductRecord> productRecordRepository, IRepository<ProductPriceRecord> productPriceRecordRepository)
        {
        ...
        public Product GetByBusinessId(string businessId)
        {
            ...
            {
                throw new ArgumentException("Product not found.", "businessId");
            }
        ...
        public void Create(Product product)
        {
            ...
            productRecord = productRecordRepository.Table.FirstOrDefault(p => p.ProductBusinessId.Equals(product.ProductBusinessId));
            IEnumerable<ProductPriceRecord> productPriceRecordsForAdding = product.Prices.Select(productPrice => productPriceMapper.GetProductPriceRecord(0, productRecord.Id, productPrice));
